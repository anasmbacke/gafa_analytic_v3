package com.gafapay.elasticsearch.api.transactionperformance.model.request;
...
public class UserTransactionPerformanceRequest extends CommonAPIDataRequest {
   ...
   public UserTransactionPerformanceRequest() {
   }
}
