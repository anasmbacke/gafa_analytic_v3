package com.gafapay.elasticsearch.api.topmostearneragents.model.request;
...
public class TopMostEarnerAgentsRequest extends CommonAPIDataRequest {
   ...
   public TopMostEarnerAgentsRequest() {
   }
}
