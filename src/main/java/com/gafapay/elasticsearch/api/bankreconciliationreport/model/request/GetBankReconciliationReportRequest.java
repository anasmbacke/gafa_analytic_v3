package com.gafapay.elasticsearch.api.bankreconciliationreport.model.request;
...
public class GetBankReconciliationReportRequest extends CommonAPIDataRequest {
   ...
   public GetBankReconciliationReportRequest() {
   }
}
