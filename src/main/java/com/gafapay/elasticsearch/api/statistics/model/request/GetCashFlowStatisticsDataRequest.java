...
public class GetCashFlowStatisticsDataRequest extends CommonAPIDataRequest {
   ...
   public boolean checkBadRequest() {
      if (Objects.isNull(this.getDate_filter())) {
         ...
         return true;
      } else if (Objects.isNull(this.getDropdown_filter())) {
         return true;
      } else {
         return StringUtils.isEmpty(this.getDropdown_filter().getAdmin_user_id());
      }
   }
   ...
   public GetCashFlowStatisticsDataRequest() {
   }
}
